...
<div class="page-header">
    <div>
        ...
        <h2>Clients</h2>
        <p>Manage individual and business clients</p>
    </div>

    @can('clients.create')
    <a href="{{ route('clients.create') }}" class="btn-add-user">
...
<div class="table-card">
    ...
    <div class="table-card-header">
        <div class="table-card-header-left">
            ...
            <span class="users-count">{{ $clients->total() }} total</span>
        </div>
                    ...
                    <td>
                        <div class="user-cell">
                            ...
                            <div>
                                ...
                                <div class="user-id">#{{ $client->id }}</div>
                            </div>
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="action-cell">
                            ...
                            <form action="{{ route('clients.destroy', $client) }}"
                                  method="POST"
                                  onsubmit="return confirm('Delete client {{ addslashes($client->display_name) }}?')">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
