...
<style>
    ...
    .form-card-title { font-family: 'Playfair Display', serif; font-size: 1rem; font-weight: 700; color: var(--text-main); margin: 0; }
    ...
    .pf-textarea { padding: 12px 16px; resize: vertical; min-height: 90px; }
    .pf-select {
        padding-right: 36px;
    ...
    .invalid-msg { font-size: .78rem; color: #E05252; margin-top: 5px; display: flex; align-items: center; gap: 5px; }

    .toggle-row { display: flex; flex-wrap: wrap; gap: 16px; margin-bottom: 8px; }
    .toggle-card {
    ...
    .stage-header-icon {
        ...
        display: flex; align-items: center; justify-content: center;
        color: #2563EB; font-size: .88rem;
    }
    .stage-title { font-family: 'Playfair Display', serif; font-size: .95rem; font-weight: 700; color: var(--text-main); }
    .btn-add-stage {
        display: inline-flex; align-items: center; gap: 7px;
        padding: 8px 16px; border-radius: 9px;
        border: 1.5px solid rgba(37,99,235,.25); background: rgba(37,99,235,.06);
        color: #2563EB; font-family: 'DM Sans', sans-serif;
    ...
    .stage-item-header { display: flex; align-items: center; justify-content: space-between; margin-bottom: 14px; }
    .stage-number { display: flex; align-items: center; gap: 9px; }
    .stage-num-badge {
    ...
    .stage-num-label { font-size: .85rem; font-weight: 600; color: var(--text-main); }
    .btn-remove-stage {
    ...
    .btn-cancel {
        ...
        color: var(--text-sub); text-decoration: none; transition: .2s;
    }
...
<div class="form-page-header">
    <div>
        ...
        <h2>Edit Service</h2>
        <p>Update details for <strong>{{ $service->name }}</strong></p>
    </div>
    ...
    <div class="form-card">
        <div class="form-card-header">
            ...
            <div>
                ...
                <div class="form-card-sub">Update service information and billing configuration</div>
            </div>
        </div>
        <div class="form-card-body">
            ...
            <div class="toggle-row">
                ...
                <label class="toggle-card {{ old('is_active', $service->is_active) ? 'on' : '' }}">
                    <input type="checkbox"
                           name="is_active"
                           id="isActive"
